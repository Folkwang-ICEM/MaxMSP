...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 394.0, 383.0, 100.0, 20.0 ],
					"text" : "Comment:",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 194.0, 607.0, 42.0, 22.0 ],
					"text" : "t 0 b 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 194.0, 570.0, 56.0, 22.0 ],
					"text" : "route 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 194.0, 536.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 761.0, 285.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 457.0, 19.0, 150.0, 60.0 ],
...
,
					"patching_rect" : [ 761.0, 254.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 761.0, 325.0, 104.0, 22.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 480.0, 254.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.0, 327.0, 150.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 327.0, 82.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1033.5, 144.0, 976.0, 144.0, 976.0, 150.0, 973.5, 150.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"midpoints" : [ 54.5, 80.0, 267.0, 80.0, 267.0, 104.0, 280.5, 104.0 ],
					"order" : 0,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 54.5, 80.0, 42.0, 80.0, 42.0, 104.0, 54.5, 104.0 ],
					"order" : 6,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 54.5, 80.0, 75.0, 80.0, 75.0, 104.0, 89.5, 104.0 ],
					"order" : 5,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 54.5, 80.0, 111.0, 80.0, 111.0, 104.0, 124.5, 104.0 ],
					"order" : 4,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 54.5, 80.0, 231.0, 80.0, 231.0, 104.0, 245.5, 104.0 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 54.5, 80.0, 198.0, 80.0, 198.0, 104.0, 210.5, 104.0 ],
					"order" : 2,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 54.5, 80.0, 162.0, 80.0, 162.0, 104.0, 175.5, 104.0 ],
					"order" : 3,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"midpoints" : [ 1077.5, 144.0, 976.0, 144.0, 976.0, 150.0, 973.5, 150.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 489.5, 240.0, 770.5, 240.0 ],
					"order" : 0,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 222.0, 603.0, 312.0, 603.0, 312.0, 858.0, 245.5, 858.0 ],
					"source" : [ "obj-64", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 215.0, 630.0, 132.0, 630.0, 132.0, 444.0, 42.0, 444.0, 42.0, 408.0, 54.5, 408.0 ],
					"source" : [ "obj-71", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 226.5, 630.0, 132.0, 630.0, 132.0, 795.0, 54.5, 795.0 ],
					"source" : [ "obj-71", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-70", 0 ],
					"midpoints" : [ 203.5, 630.0, 132.0, 630.0, 132.0, 795.0, 54.5, 795.0 ],
					"source" : [ "obj-71", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 89.5, 165.0, 96.0, 165.0, 96.0, 366.0, 360.5, 366.0 ],
					"order" : 0,
					"source" : [ "obj-94", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 124.5, 366.0, 820.5, 366.0 ],
					"order" : 0,
					"source" : [ "obj-95", 0 ]
				}
